      ...
      <div className="container-fluid flex items-center justify-between">
        ...
        <div className="flex items-center h-auto pl-[10px] md:pl-[20px] xl:py-0 py-[20px]">
          <a href="#">
            ...
            <h1 className="text-white font-extrabold text-4xl">QTFx</h1>
          </a>
        </div>
        {/* Search */}
        <Search ref={search} />
        ...
        <ul className="flex items-center">
          ...
          <a
            href="https://dashboard.qtfx.space/sign-up.php"
            id=""
  ...
  return (
    <div ref={ref} className="mobile-nav-wrapper xl:hidden">
      ...
      <nav className="mobile-nav-content">
        ...
        {/*  */}
        <div className="mb-[30px] flex justify-center flex-row">
          <a href="#">
            {/* <img src={logo} width="140" alt="" /> */}
            <h1 className="font-extrabold text-white text-3xl">QTFx</h1>
          </a>
        </div>
        {/*  */}
        <a
          className="w-full text-center mx-0 mb-[20px] text-white flex items-center bg-custom-orange justify-center h-[45px]"
          href="https://dashboard.qtfx.space/sign-in.php"
        >
          Login
        </a>
        {/*  */}
